...
export default function Sidebar({ currentTab, onTabChange, settings }: SidebarProps) {
  ...
  return (
    <>
      ...
      <div className="flex items-center justify-between bg-white border-b border-[#E4E4E7] px-4 py-3 text-[#18181B] md:hidden">
        <div className="flex items-center gap-2">
          <div className="flex h-8 w-8 items-center justify-center rounded bg-[#18181B] font-mono text-sm font-bold text-white">
            {logoInitial}
          </div>
        ...
        <button 
          ...
          className="rounded p-1 hover:bg-[#F4F4F5] text-[#18181B] focus:outline-none"
        >
      ...
      `}>
        ...
        <div className="hidden items-center gap-3 border-b border-[#E4E4E7] px-6 py-5 md:flex">
          <div className="flex h-8 w-8 shrink-0 items-center justify-center rounded bg-[#18181B] font-sans text-sm font-bold text-white">
            {logoInitial}
          </div>
          <div className="flex flex-col min-w-0">
            <span className="truncate font-sans text-sm font-bold tracking-tight text-[#18181B]">{name}</span>
              ...
              <button
                ...
                className={`
                  ...
                  ${isActive 
                    ...
                    : 'text-[#71717A] hover:bg-[#F9F9F9] hover:text-[#18181B]'}
                `}
              >
                <div className="flex items-center gap-3">
                  <Icon className={`h-4 w-4 shrink-0 ${isActive ? 'text-[#18181B]' : 'text-[#A1A1AA]'}`} />
        ...
        <div className="border-t border-[#E4E4E7] p-4">
          <div className="p-4 bg-[#F4F4F5] rounded-lg border border-[#E4E4E7]">
            <div className="flex items-start gap-2.5">
              <Sparkles className="h-4 w-4 shrink-0 text-[#18181B] mt-0.5" />
              <div className="text-[11px] leading-relaxed text-[#71717A]">
                <p className="font-semibold text-[#18181B]">AI Copilot Active</p>
